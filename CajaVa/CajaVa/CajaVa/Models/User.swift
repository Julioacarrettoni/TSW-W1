...
final class User {
    ...
    /// Different roles supported in the app for a given user
    enum Role: Int {
        /// Admin users have access to all the information
        case admin = 0
        /// Support users can only see certain elements in the app
        case support = 1
    }
